define([
     ...
     *
     * Widget initialization is a two-phase process with base initialization ({@link Widget#initializeWidget}) followed
     * by initialization when all other widgets (except for the map) are initialized ({@link Widget#onAttachInit})
     *
     * @class Widget
