define([
    ...
    var MapWidget       = arguments[3];
    var ToolbarBuilder  = arguments[4];
    var StatusBarBuilder = arguments[5];
    var MenuBuilder     = arguments[6];
    var registry        = arguments[7];
    var OpenLayers      = arguments[8];
    var topic           = arguments[9];
    var Widget          = arguments[10];
    var script          = arguments[11];
    var all             = arguments[12];
        ...
        initialize: function(done, fail) {
            ...
            var onModulesRequested = function() {
                ...
                try {
                    ...
                    topic.subscribe(Widget.Events.ACTIVATED, OpenLayers.Function.bind(that.onWidgetActivated, that));
