define([
    ...
    //HACK: Can't pull in widget! I just want its event!
    var ACTIVATED_EVENT = "fusion/widget/activated";
    ...
    var Runtime = declare(null, {
        ...
        initialize: function(Fusion, done, fail) {
            ...
            var scripts = [];
            //for (var script in this.oAppDef.Extension[0]) {
            //    scripts.push(this.oAppDef.Extension[0][script][0]);
            //}
            ...
            var onModulesRequested = function() {
                ...
                try {
                    ...
                    topic.subscribe(ACTIVATED_EVENT, Func.bind(that.onWidgetActivated, that));
