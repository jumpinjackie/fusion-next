...
define([
    ...
    var MapMessage = arguments[1];
    var declare = arguments[2];
    var Widget = arguments[3];
    var LayerModel = arguments[4];
    var OpenLayers = arguments[5];
    var StringBundle = arguments[6];
    var topic = arguments[7];
    var query = arguments[8];
    var domStyle = arguments[9];
     ...
     *
     * Do not call this constructor, require() this module or create new Map widget instances directly! Fusion will 
     * always create one as part of initialization and is accessible through the {@link Fusion.getMap} function
     *
     * @class Map
     * @extends Widget
     * @property {MapMessage} message The {@link MapMessage} component
     * @example
    ...
    var Map = declare(Widget, {
        ...
        initializeWidget: function(widgetTag, mapSetTag) {
            ...
            this.message = new MapMessage({ parent: query("#" + this.domElId)[0] });
        },
        /** 
         * Gets whether the map has been loaded
         * @return true if the map is loaded, false if not
         * @memberof Map
         * @instance
         * @example
         * var Fusion = require("fusion/core");
         * var map = Fusion.getMap();
         * var isLoaded = map.isMapLoaded();
         */
        ...
        /**
         * Sets the active cursor for the map
         * @memberof Map
         * @instance
         * @param {Object} cursor A string indicating the name of the cursor or an array of strings indicating 
         * the names of cursors to set (in order of preference). For an array, the first matching cursor that is
