define([
    ...
    var Proj4js         = arguments[3];
    var Runtime         = arguments[4];
    var mapagent        = arguments[5];
    var request         = arguments[6];
    var URI             = arguments[7];

    //HACK: Yes, we're doing the antithesis of AMD, but global OpenLayers/Proj4js is needed for dynamically loading OpenStreetMap.js
    ...
    */
    ...
    var Fusion = {
        ...
        getAssetPathForWidget: function(widgetName, fileName) {
