        ...
        formatHTML: function(p) {
            if (!this.displayProjection) {
                ...
                if(this.units == Fusion.Unit.DEGREES && mapUnit != 'dd' && mapUnit != 'degrees' ) {
                    ...
                    var dest = new OpenLayers.Projection("EPSG:4326");//"GEOGCS[\"LL84\",DATUM[\"WGS84\",SPHEROID[\"WGS84\",6378137.000,298.25722293]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.01745329251994]]");
